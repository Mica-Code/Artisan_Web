      ...
      <div class="content-wrapper" style="margin-top:-10px;">
         ...
         <div class="row card">
            ...
            <div class="col-md-6 card text-center">
               <img src="images/btc.png" style="width: 200px;">
               <hr>


               <img src="../admin/uploads/<?php echo $pm_btc_bar_code ?>" style="width: 250px;">
               <!-- <span></span> -->

               <input class="bold" type='text' id='copy' readonly value='<?php echo $pm_btc_address?>' style="font-size: 22px; border:0ch; padding:5px; margin: 10px; width:100%; text-align: center;">
               ...
               <h5 class="">Make the Payment for the investment in the below BTC address.<br></h5>
            </div>
