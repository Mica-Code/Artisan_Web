...
if(empty($error)){
    ...
    $query = "UPDATE art_reg_tbl SET fullname='$fullName', username='$username', email='$email', phone='$phone', location='$location', age='$age', about='$about' WHERE userID=$session_id" or die(mysqli_error($dbc));;
