                    ...
                    <div class="main-featured-sec">
                        ...
                        <div class="job-search-sec">
                            <div class="job-search">
                                <br /><br />
                                <h4 style="text-align:left;color:#006600">find handymen or artisans in Nigeria</h4>
                                <span style="color:darkslategray">Get help around the house or office from a nearby artisan</span>
...
<option value="Window Installation">Window Installation</option>
                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12">
                                            <div class="job-field">
                                                <b style="font-weight:600;"> <select class="chosen" id="Location" name="Location"><option value="">Where or what location?</option>
