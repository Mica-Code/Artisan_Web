...
<head>
    ...
    <title>Artisan_hub | Find Artisan</title>
    ...
    <div class="theme-layout" id="scrollup">
            ...
            <div class="responsive-opensec ">
                ...
                <div class="responsivemenu">
                    <ul>
                        ...
                        <li>
                            <a href="handyJobs.htm">Browse tasks</a>
                        </li>
                        <li>
        ...
        <header class="stick-top forsticky new-header">
            <div class="menu-sec">
                <div class="container">
                    <div class="logo">
                        <a href="../myhandwork_default.html"><img src="../Uploads/General/myhandworkng-logo.png" alt="myhandwork.ng" /></a>
                    </div><!-- Logo -->
                    <div class="btn-extars">
                            <a class="post-job-btn" href="../Account/getStarted.htm"><i class="la la-registered"></i>Register now</a>
                            <ul class="account-btns">
                                <li><a href="../Account/Login.htm"><i class="la la-sign-in"></i> Login</a></li>
                            </ul>
                    </div><!-- Btn Extras -->
...
<form action="../Handworks.htm" class="job_filters" method="post">                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="job-field">
...
<option value="Bricklayer and Mason">Bricklayer and Mason</option>
<option value="CableTV and CCTV Installer">CableTV and CCTV Installer</option>
<option value="CableTV Installation">CableTV Installation</option>
<option value="Car Rewire and Car tracker">Car Rewire and Car tracker</option>
<option value="Car Upholstery">Car Upholstery</option>
<option value="Car Wash">Car Wash</option>
<option value="Carpentry">Carpentry</option>
<option value="Catering">Catering</option>
<option value="CCTV / Biometric Access Control">CCTV / Biometric Access Control</option>
<option value="Ceiliing Repair">Ceiliing Repair</option>
<option value="Ceramic and tiling">Ceramic and tiling</option>
<option value="Cleaning">Cleaning</option>
<option value="Cobbler">Cobbler</option>
<option value="Cosmetologists">Cosmetologists</option>
<option value="Craftman">Craftman</option>
<option value="Curtain Hanging">Curtain Hanging</option>
<option value="Deck Building">Deck Building</option>
<option value="Digital Marketing">Digital Marketing</option>
<option value="Door Installation And Repair">Door Installation And Repair</option>
...
<option value="Event Usher">Event Usher</option>
...
<option value="Gadgets Repairs">Gadgets Repairs</option>
<option value="Gardening">Gardening</option>
<option value="Gas Man">Gas Man</option>
<option value="Hair Stylist">Hair Stylist</option>
<option value="Heating Systems">Heating Systems</option>
<option value="Heavy Duty Machines">Heavy Duty Machines</option>
<option value="Horticulturist">Horticulturist</option>
<option value="Hot Tubs and Spa">Hot Tubs and Spa</option>
...
<option value="Mini Generators">Mini Generators</option>
<option value="Motor mechanic">Motor mechanic</option>
<option value="Musical studio">Musical studio</option>
<option value="Networking and Access Control">Networking and Access Control</option>
<option value="Painting">Painting</option>
<option value="Panel Beater">Panel Beater</option>
<option value="Patio Stone Installation">Patio Stone Installation</option>
<option value="Pest Control">Pest Control</option>
<option value="Photography">Photography</option>
<option value="Plumbing">Plumbing</option>
<option value="POP Ceiling Services">POP Ceiling Services</option>
...
<option value="Solar and Inverter Technician">Solar and Inverter Technician</option>
<option value="Solar Panels">Solar Panels</option>
<option value="Soundproof and Mini Generators">Soundproof and Mini Generators</option>
<option value="Soundproof Generators">Soundproof Generators</option>
...
<option value="Video and Graphics">Video and Graphics</option>
<option value="vulcanizer">vulcanizer</option>
<option value="Wall Building">Wall Building</option>
<option value="Wallpapering">Wallpapering</option>
<option value="Waste and Junk Removal">Waste and Junk Removal</option>
...
<option value="Window Installation">Window Installation</option>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="job-field">
                                                ...
                                                <b style="font-weight:600;">
                                                    <select class="chosen" id="location" name="location"><option value="">Where or what location?</option>
...
<option selected="selected" value="Lagos State">Lagos State</option>
