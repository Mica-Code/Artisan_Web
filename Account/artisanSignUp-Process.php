...
if(empty($error)){
    ...
    $query = "INSERT into art_reg_tbl (fullname, username, email, password, phone, status, age, handwork, address, skill_desc, location, reg_date) 
    values ('$fullname', '$username', '$email', '$hashed_pass', '$phone', 'artisan', '$age', '$handwork', '$address', '$skill_desc', '$location', now())" or die(mysqli_error($dbc));
