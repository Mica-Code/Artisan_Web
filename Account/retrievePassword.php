...
<form action="" method="post">                                    <div class="cfield">
                                        <input type="text" name="pass" id="pass" placeholder="Enter your new password" class="form-control" />
                                        <i class="la la-codepen"></i>

                                    </div>
                                    <div class="cfield">
                                        <input type="text" name="cfmpass" id="cfmpass" placeholder="Confirm new password" class="form-control" />
                                        <i class="la la-codepen"></i>
