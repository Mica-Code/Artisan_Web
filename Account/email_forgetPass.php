...
// 		);
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <h2 class="size-36" style="Margin-top: 0;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #e31212;font-size: 30px;line-height: 38px;font-family: pt serif,georgia,serif;text-align: center;" lang="x-size-36"><span class="font-pt-serif"><span style="color:#fff">RESET PASSWORD</span></span></h2>
      </div>
    </div>
...
<span style="color:#000000">&nbsp; A Password Request has been made, <br>click the link blow to reset your password.<br />
<a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #18527c;" 
href="https://lekkilersa.org/Artisan_Web/Account/retri.php?vkey='.$acct_code.'" target="_blank">Link</a>
...
&nbsp; Login into your dashboard using your registered<br> E-mail Address and Password by clicking on this 
<a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #18527c;" 
href="https://lekkilersa.org/Artisan_Web/Account/verify.php?vkey='.$acct_code.'" target="_blank">Link</a> </span></span>      </p>
      </div>
            </div>
            <div style="Margin-left: 20px;Margin-right: 20px;">
      ...
      <div style="line-height:40px;font-size:40px;"></div>
        ...
        header('location: forgotPassword.php?chk=sent');
        mysqli_close($dbc);
        exit();
		};
