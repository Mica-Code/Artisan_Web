...
<html>
  <head>
    ...
    <link
      rel="icon"
      href="../Uploads/General/myhandworkng.png"
      type="image/x-icon"
    />
  </head>
  <body class="newbg">
    <div class="theme-layout" id="scrollup">
      <div class="responsive-header three">
        <div class="responsive-menubar">
          <div class="res-logo">
            <a title="" href="../myhandwork_default.html"
              ><img src="../Uploads/General/myhandworkng-logo.png" alt=""
            /></a>
          </div>
          <div class="menu-resaction">
            <div class="res-openmenu">
              <img src="../images1/icon.png" alt="" /> Menu
              <i class="la la-bars"></i>
            </div>
            <div class="res-closemenu">
              <img src="../images1/icon2.png" alt="" /> Close
        ...
        <div class="responsive-opensec">
          <div class="btn-extars">
            <a class="post-job-btn" href="index.php"
              ><i class="la la-registered"></i>Register now</a
            >
            <ul class="account-btns">
              <li>
                <a href="Login.htm"><i class="la la-sign-in"></i> Login</a>
              </li>
            </ul>
          </div>
      ...
      <header class="stick-top forsticky new-header">
        <div class="menu-sec">
          <div class="container">
            <div class="logo">
              <a href="../myhandwork_default.html"
                ><img src="../Uploads/General/myhandworkng-logo.png" alt=""
              /></a>
            </div>
            <!-- Logo -->
                  ...
                  <div class="account-popup-area signup-popup-box static">
                    <div class="account-popup">
                      ...
                      <!-- <form action="Signup.php" method="post"> -->
                              ...
                              <div class="col-lg-6">
                                ...
                                <div class="pf-field">
                                  <select class="chosen" data-val="true" data-val-required="Location is required" id="area" name="area" value="<?php if (isset($_POST['area'])) echo $_POST['area'];  ?>">
                                    ...
                                    <option value="Alakumosa East">
                                      Alakumosa East
                                    </option>
                                    <option value="Alakumosa West">
                                      Alakumosa West
                                    </option>
                                    ...
                                    <option value="Benue State">
                                      Benue State
                                    </option>
                                    <option value="Berger Lagos">
                                      Berger Lagos
                                    </option>
                                    ...
                                    <option value="Dutse-Jigawa">
                                      Dutse-Jigawa
                                    </option>
                                    <option value="Dutsin-Ma">Dutsin-Ma</option>
                                    <option value="Eatern Obolo">
                                      Eatern Obolo
                                    </option>
                                    <option value="Ebonyi">Ebonyi</option>
                                    <option value="Ebonyi State">
                                      Ebonyi State
                                    </option>
                                    ...
                                    <option value="Ekiti State">
                                      Ekiti State
                                    </option>
                                    <option value="Ekiti-Kwara">
                                      Ekiti-Kwara
                                    </option>
                                    ...
                                    <option value="Ifelodun-Kwara">
                                      Ifelodun-Kwara
                                    </option>
                                    <option value="Ifelodun-Osun">
                                      Ifelodun-Osun
                                    </option>
                                    ...
                                    <option value="Ikotun-Igando">
                                      Ikotun-Igando
                                    </option>
                                    <option value="Ikoyi">Ikoyi</option>
                                    <option value="Ikpoba-Hill">
                                      Ikpoba-Hill
                                    </option>
                                    ...
                                    <option value="Ile-Oluji-Okelgbo">
                                      Ile-Oluji-Okelgbo
                                    </option>
                                    ...
                                    <option value="Irepodun-Kwara">
                                      Irepodun-Kwara
                                    </option>
                                    <option value="Irepodun-Osun">
                                      Irepodun-Osun
                                    </option>
                                    ...
                                    <option value="Nasarawa State">
                                      Nasarawa State
                                    </option>
                                    <option value="Nasarawa-Eggon">
                                      Nasarawa-Eggon
                                    </option>
                                    <option value="Nasarawa-Kano">
                                      Nasarawa-Kano
                                    </option>
                        ...
                        <!-- <div class="row">
                          <div class="col-lg-6">
                            <input type="text" class="form-control input-bg" placeholder="First name" id="fname" name="fname">
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="form-control input-bg" placeholder="Last name" id="lname" name="lname">
                          </div>
                        </div>

                        <div class="row">
                          <div class="col-lg-6">
                            <select class="custom-select mr-sm-2" id="location" name="location"><option value="">Select Location</option>
                              <option value="Aba">Aba</option>
                              <option value="Abadam">Abadam</option>
                              <option value="Abaji">Abaji</option>
                              <option value="Abakaliki">Abakaliki</option>
                        ...
                        <div class="row">
                              ...
                              <div class="cfield">
                                <select class="chosen" id="location" name="location"><option value="">Select Location</option>
                                    <option value="Aba">Aba</option>
                                    <option value="Abadam">Abadam</option>
                                    <option value="Abaji">Abaji</option>
                                    <option value="Abakaliki">Abakaliki</option>
                                ...
                                <i class="la la-location"></i>
                              </div>

                              <div class="col-lg-6 cfield">
                                <input
                                  class="form-control text-box single-line"
                                  id="dob"
                                  name="dob"
                          ...
                          <div class="simple-checkbox">
                            <p>
                              <input
                                checked="checked"
                                data-val="true"
                                data-val-required="The agreement field is required."
                                id="agreement"
                                name="agreement"
                                type="checkbox"
                                value="true"
                              /><label for="agreement"
                                >I agree with
                                <a
                                  href="../Home/TermsandCondition.htm"
                                  target="_blank"
